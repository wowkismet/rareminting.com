...
export const metadata: Metadata = { title: 'Backup & Security' };
...
export default async function Page() {
  return <DashboardShell user={await currentUser()} eyebrow="Admin Panel" title="Backup & Security" subtitle="Manage backups and security settings" sections={s} current="/admin/backup"><Panel title="Backup"><p className="text-sm text-slate-dim">Backup and security interface coming soon.</p></Panel></DashboardShell>;
}
