...
export default async function Page() {
  return <DashboardShell user={await currentUser()} eyebrow="Admin Panel" title="Categories" subtitle="Manage product categories" sections={s} current="/admin/categories"><Panel title="Categories"><p className="text-sm text-slate-dim">Categories management interface coming soon.</p></Panel></DashboardShell>;
}
