...
export default async function Page() {
  return <DashboardShell user={await currentUser()} eyebrow="Admin Panel" title="KYC Verification" subtitle="Review seller KYC documents" sections={s} current="/admin/kyc"><Panel title="KYC"><p className="text-sm text-slate-dim">KYC verification interface coming soon.</p></Panel></DashboardShell>;
}
