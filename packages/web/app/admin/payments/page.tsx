...
export default async function Page() {
  return <DashboardShell user={await currentUser()} eyebrow="Admin Panel" title="Payments & Payouts" subtitle="Monitor payments and seller payouts" sections={s} current="/admin/payments"><Panel title="Payments"><p className="text-sm text-slate-dim">Payments management interface coming soon.</p></Panel></DashboardShell>;
}
