...
export const metadata: Metadata = { title: 'Products & Listings' };
...
export default async function AdminProductsPage() {
  ...
  return <DashboardShell user={user} eyebrow="Admin Panel" title="Products & Listings" subtitle="Manage product catalog and listings" sections={sections} current="/admin/products"><Panel title="Products"><p className="text-sm text-slate-dim">Products management interface coming soon.</p></Panel></DashboardShell>;
}
