...
export const metadata: Metadata = { title: 'Promotions & Banners' };
...
export default async function Page() {
  return <DashboardShell user={await currentUser()} eyebrow="Admin Panel" title="Promotions & Banners" subtitle="Manage platform promotions and banners" sections={s} current="/admin/promotions"><Panel title="Promotions"><p className="text-sm text-slate-dim">Promotions management interface coming soon.</p></Panel></DashboardShell>;
}
