...
export default async function Page() {
  return <DashboardShell user={await currentUser()} eyebrow="Admin Panel" title="Reports & Analytics" subtitle="View platform analytics and reports" sections={s} current="/admin/reports"><Panel title="Reports"><p className="text-sm text-slate-dim">Reports interface coming soon.</p></Panel></DashboardShell>;
}
