...
export const metadata: Metadata = { title: 'Reviews & Feedback' };
...
export default async function Page() {
  return <DashboardShell user={await currentUser()} eyebrow="Admin Panel" title="Reviews & Feedback" subtitle="Monitor user reviews and feedback" sections={s} current="/admin/reviews"><Panel title="Reviews"><p className="text-sm text-slate-dim">Reviews management interface coming soon.</p></Panel></DashboardShell>;
}
