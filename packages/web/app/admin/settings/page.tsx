...
export default async function Page() {
  return <DashboardShell user={await currentUser()} eyebrow="Admin Panel" title="System Settings" subtitle="Configure platform settings" sections={s} current="/admin/settings"><Panel title="Settings"><p className="text-sm text-slate-dim">System settings interface coming soon.</p></Panel></DashboardShell>;
}
