...
export default async function Page() {
  return <DashboardShell user={await currentUser()} eyebrow="Admin Panel" title="Transactions" subtitle="View all platform transactions" sections={s} current="/admin/transactions"><Panel title="Transactions"><p className="text-sm text-slate-dim">Transactions interface coming soon.</p></Panel></DashboardShell>;
}
